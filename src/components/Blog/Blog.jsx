      ...
      <div className="flex gap-3 flex-col items-center ">
        ...
        <div className="card w-96 bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <p>
              এটি রিয়্যাক্ট এর একটি হুক যা ব্যবহার করে আমরা কোন ভারি কাজ যাতে
              পরিবর্তন না হলে বার বার রি রেন্ডার না হয়। শুধুমাত্র যখন পরিবর্তন
              হবে তখন ই রি রেন্ডার হবে কোন ভারি কাজ যাতে পরিবর্তন না হলেও
              রিরেন্ডার না হয় সে জন্য useMemo হুক এর ভিতরে রাখতে হয়।
            </p>
          </div>
        </div>
      </div>
